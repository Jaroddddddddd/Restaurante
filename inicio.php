...
<body>
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                ...
                <small><b class="ml-2">BIBLIOTECA </b></small>
            </div>
            <ul class="list-unstyled components">
                <li class="">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><span class="icofont- mr-3 h4 text-white"></span>Libros<i class="icofont-rounded-down text-white"></i></a>
                ...
                <div class="col-md-5 col-lg-3 p-0 p-1">
                    <div class="row no-gutters bg-white shadow-sm">
                        <div class="col-md-3 bg-danger p-3">
                            <span class="icofont- h1 text-white"></span>
                        </div>
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <br>
                    <small>Ciudad: Manta</small>
                    <br>
                    <small>Proviencia: Manabí</small>
                    <br>
                    <small>País: Ecuador</small>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <br>
                    <small>Email: biblioteca@gmail.com</small>
                    <br>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <br>
                    <small>Telefono: 0999999999</small>
                    <br>
                  </div>
                </div>
              </div>
    ...
    <footer class=" ">
        <div class="container-fluid text-center">
            <div class="row">
                <div class="col-md-4">
                    <p class="text-white pt-3"><small><b>Copyright &copy; 2020 </b>Biblioteca todos los derechos reservados</small></p>
                </div>  
